...
const Product4 = () => {
    ...
    return (<div>
        <div className="p-4  rounded-3xl ">
            ...
            {/* Banner 4 - Giảm giá Valentine Trắng */}
            <div className="flex justify-center w-full">
                <div className="relative flex items-center justify-center w-[95%] max-w-screen-lg px-12 py-4 bg-gradient-to-r from-pink-500 to-pink-600 rounded-full shadow-lg">
                    ...
                    <img src="https://i.imgur.com/NM50Xa5.png" alt="Nơ"
                        className="absolute left-4 top-1/2 transform -translate-y-1/2 w-14 h-14 md:w-16 md:h-16" />
                    ...
                    <img src="https://i.imgur.com/vb3O2F3.png" alt="Trái tim"
                        className="absolute right-4 top-1/2 transform -translate-y-1/2 w-12 h-12 md:w-14 md:h-14 animate-pulse" />
                </div>
            </div>
